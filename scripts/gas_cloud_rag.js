...
'.logout-btn{font-size:.72rem;padding:3px 9px;border-radius:99px;background:#fee2e2;color:#991b1b;',
...
'    <h3>Unity / Houdini 外部クライアントの使い方</h3>',
'    <p style="margin-bottom:8px">発行したAPIキーを使って以下の形式でPOSTしてください:</p>',
...
'}',
'    </pre>',
'    <p style="margin-top:8px">レスポンス: <code>{"answer":"...","sources":[...],"status":"ok"}</code></p>',
'  </div>',
'</div>',
'</div>',
