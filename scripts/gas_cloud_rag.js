...
'body{font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;height:100vh;display:flex;flex-direction:column;width:100%;min-width:320px}',
...
'/* 管理サブタブ */',
'.admin-sub-bar{display:flex;border-bottom:1px solid var(--dborder);margin-bottom:18px;gap:2px}',
'.admin-sub-btn{flex:1;padding:8px;font-size:.82rem;font-weight:600;border:none;background:none;',
'  cursor:pointer;color:#64748b;border-bottom:2px solid transparent;font-family:inherit;transition:all .15s}',
'.admin-sub-btn.active{color:var(--accent);border-bottom-color:var(--accent)}',
'.admin-sub-btn:hover:not(.active){color:#e2e8f0}',
